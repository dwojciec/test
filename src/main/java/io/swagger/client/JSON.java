 ...
 * AHOI API
 *
 * AHOI (working title) is our managed and flexible multi-banking API 
 * designed to offer easy access to your users bank accounts.  
...
public class JSON {
	...
	public JSON(ApiClient apiClient) {
		...
		gson = new GsonBuilder()
				...
				//FIXED registerTypeAdapter(...) for deserialization to type
				.registerTypeAdapter(Provider.class, new ProviderTypeAdapter<Provider>())
				.registerTypeAdapter(Notification.class, new ProviderTypeAdapter<Notification>())
				.registerTypeAdapter(Account.class, new ProviderTypeAdapter<Account>())
				.registerTypeAdapter(Transaction.class, new ProviderTypeAdapter<Transaction>())
				.registerTypeAdapter(Access.class, new ProviderTypeAdapter<Access>())
				.create();
	}
	...
	public String serialize(Object obj) {
		//FIXED updateTypeField(obj) for subtyping
		updateTypeField(obj);
		return gson.toJson(obj);
	}

	//FIXED
	private void updateTypeField(Object obj) {
		if (obj != null && isInstanceOfSubtype(obj)) {
			try {
				Method method = obj.getClass().getMethod("setType", String.class);
				method.invoke(obj, obj.getClass().getSimpleName());
	...
	private boolean isInstanceOfSubtype(Object obj) {
...
class DateTimeTypeAdapter extends TypeAdapter<DateTime> {
	...
	//FIXED dateTime() -> dateTimeNoMillis()
...
class ProviderTypeAdapter<T> implements JsonDeserializer<T> {
	...
	public T deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
		...
		Class<?> klass = null;
		try {
			klass = Class.forName("io.swagger.client.model." + className);
