...
public class NewTransactionNotification extends Notification  {
  ...
  public NewTransactionNotification accountId(Long accountId) {
  ...
  **/
  ...
  public NewTransactionNotification lowerThreshold(Amount lowerThreshold) {
  ...
  **/
  ...
  public NewTransactionNotification upperThreshold(Amount upperThreshold) {
  ...
  **/
  ...
  public NewTransactionNotification searchKeyword(String searchKeyword) {
    this.searchKeyword = searchKeyword;
    return this;
  }

   /**
   * Optional limitation on transactions for given keywords (e.g., owner \"Hans Muster\" or purpose \"Salary\")
   * @return searchKeyword
  **/
  @ApiModelProperty(example = "null", value = "Optional limitation on transactions for given keywords (e.g., owner \"Hans Muster\" or purpose \"Salary\")")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NewTransactionNotification newTransactionNotification = (NewTransactionNotification) o;
    return Objects.equals(this.accountId, newTransactionNotification.accountId) &&
        Objects.equals(this.lowerThreshold, newTransactionNotification.lowerThreshold) &&
        Objects.equals(this.upperThreshold, newTransactionNotification.upperThreshold) &&
        Objects.equals(this.searchKeyword, newTransactionNotification.searchKeyword) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, lowerThreshold, upperThreshold, searchKeyword, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NewTransactionNotification {\n");
