...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        authentications.put("apiKey", new ApiKeyAuth("header", "X-SF-AHOI-TEST-Principal"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://banking-sandbox.starfinanz.de/ahoi/api
